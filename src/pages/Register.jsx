            ...
            <div style={{ display: 'flex', flex: 1, minHeight: 0 }}>
                ...
                <div style={{
                    ...
                    <div style={{ marginBottom: "3rem", textAlign: "center" }}>
                        <h1 style={{ fontSize: "2.4rem", fontWeight: 800, margin: 0, letterSpacing: '-1.5px' }}>Create Account</h1>
                        <p style={{ color: '#666', marginTop: '0.5rem' }}>Start your technical training journey.</p>
                    </div>

                    <div style={{ width: "100%", maxWidth: '400px' }}>
                        <form onSubmit={handleSubmit} style={{ display: "grid", gap: "1.5rem" }}>
                            <div>
                                <label style={{ fontSize: "0.75rem", color: "#666", display: "block", marginBottom: "0.8rem", fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>Full Name</label>
                                <input
                                    name="name"
                            ...
                            <div>
                                <label style={{ fontSize: "0.75rem", color: "#666", display: "block", marginBottom: "0.8rem", fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>Email Address</label>
                                <input
                                    name="email"
                                    type="email"
                            ...
                            <div>
                                <label style={{ fontSize: "0.75rem", color: "#666", display: "block", marginBottom: "0.8rem", fontWeight: 700, textTransform: 'uppercase', letterSpacing: '1px' }}>Master Password</label>
                                <input
                                    name="password"
                                    type="password"
                            ...
                            <button
                                ...
                                disabled={loading}
                            >
                                {loading ? <Loader /> : "Generate Operative Account"}
                            </button>
                        </form>

                        <p style={{ marginTop: "3rem", fontSize: "0.95rem", color: "#444", textAlign: "center" }}>
                            Existing operative? <Link to="/login" style={{ color: "#fff", textDecoration: 'none', fontWeight: 700 }}>Initialize Login</Link>
                        </p>
                    </div>
